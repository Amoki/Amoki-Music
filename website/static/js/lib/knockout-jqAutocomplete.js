...
;(function(factory) {
  ...
  var JqAuto = function() {
    var self = this;
    var unwrap = ko.utils.unwrapObservable; // support older KO versions that did not have ko.unwrap
    ...
    this.init = function(element, valueAccessor, allBindings, data, context) {
      ...
      var config = {};
      var filter = typeof options.filter === "function" ? options.filter : self.defaultFilter;
    ...
    this.update = function(element, valueAccessor) {
      ...
      var sources;
      var options = unwrap(valueAccessor());
      var value = unwrap(options && options.value);
    ...
    this.processOptions = function(valueAccessor, filter, data, request, response) {
      ...
      var results = [];
      var props = this.getPropertyNames(valueAccessor);
    ...
    this.renderItem = function(templateName, context, ul, item) {
      ...
      var itemContext = context.createChildContext(item.data);
