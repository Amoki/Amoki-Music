...
class RoomSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Room
        fields = ('name', 'current_music', 'shuffle', 'can_adjust_volume', 'count_left', 'time_left', 'current_time_left', 'current_time_past', 'current_time_past_percent', 'playlist', 'token', 'password')
